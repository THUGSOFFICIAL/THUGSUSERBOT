...
if PMPERMIT_PIC is None:
  WARN_PIC = "https://telegra.ph/file/0c3bee37fb057c29510ea.jpg"
else:
        ...
        if event.is_private:
          if chat.id == 924138714:
            ...
            if pmpermit_sql.is_approved(chat.id):
                ...
                await event.edit("Pahali fursat me nikal lavde koi zarurat nahi teri idhar.....!!**[{}](tg://user?id={})".format(firstname, chat.id))
                await asyncio.sleep(3)
