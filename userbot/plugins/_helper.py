...
`Userbot to get help for a particular plug `\n__Do .help module_name for commands, in case popup doesn't appear.__"""
...
async def _(event):
    ...
    await event.edit("""Telethon UserBot Powered by @THUGUSERBOT""")
